...
f32 GPS_f32getDistance(void){
    // convert all coordinates from Degrees into Radians
    f32 Local_f32startLat = startLatitude* M_PI/180;
    f32 Local_f32startLong = startlongitude* M_PI/180;
    f32 Local_f32endLat = latitude* M_PI/180;
    f32 Local_f32endLong = longitude* M_PI/180;
    ...
    * sin(Local_f32longDifference / 2) * sin(Local_f32longDifference / 2);
    ...
    f32 copy_pf32distance = Local_f32c * Earth_Radius;
    return copy_pf32distance;
}
